...
func (c *payClient) Greet(ctx context.Context, in *PayReq, opts ...grpc.CallOption) (*PayResp, error) {
	out := new(PayResp)
	err := c.cc.Invoke(ctx, "/pay.Pay/greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PayServer interface {
	Greet(context.Context, *PayReq) (*PayResp, error)
...
func (UnimplementedPayServer) Greet(context.Context, *PayReq) (*PayResp, error) {
...
func _Pay_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PayReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PayServer).Greet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pay.Pay/greet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PayServer).Greet(ctx, req.(*PayReq))
	}
